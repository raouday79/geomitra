					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="JobRegister" method="post">
									<div class="form-group"> <label for="exampleInputEmail1">Job Name</label> <input required="required" type="text" name="job_name" class="form-control" id="exampleInputEmail1" placeholder="Email"> </div> 
									<div class="form-group"> <label for="exampleInputEmail1">Job Description</label> <input required="required" type="text" name="job_description" class="form-control" id="exampleInputEmail1" placeholder="Email"> </div> 
