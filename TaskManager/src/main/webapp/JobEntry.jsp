...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">New Job</h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Enter Job Detail :</h4>
						...
						<div class="form-body">
							<form action="JobRegister" method="post">
									<div class="form-group"> <label for="exampleInputEmail1">Job Name</label> <input required="required" type="text" name="job_name" class="form-control" id="exampleInputEmail1" placeholder="Job Name"> </div> 
									<div class="form-group"> <label for="exampleInputEmail1">Job Description</label> <input required="required" type="text" name="job_description" class="form-control" id="exampleInputEmail1" placeholder="Job Description"> </div> 
									<div class="form-group"> <label for="exampleInputEmail1">Start Date</label> <input required="required" type="date" name="job_start_date" class="form-control" value="Select date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Select date';}"> </div>
									<div class="form-group"> <label for="exampleInputEmail1">Deadline</label> <input required="required" type="date" name="job_end_date" class="form-control" value="Select date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Select date';}"> </div> 
